...
describe('SerialStorage', function () {
    ...
    describe(`with default serializer`, function () {
    ...
    describe(`with a dummy serializer`, function () {

        it('should read with the dummy', function () {
            ...
            const red = storage.read('y');
            equal('x', red);
        });

        it('should read all with the dummy', function () {
            const storage = new SerialStorage(
                {
                    abc: 'something',
                },
            ...
            const red = storage.read();
            equal({abc: 'x'}, red);
        });

        it('should write with the dummy', function () {
            const internal = {};
            const storage = new SerialStorage(
                internal,
                {
            ...
            storage.write('abc', 'y');
            equal('x', internal.abc);
        });

        it('should write all with the dummy', function () {
            const internal = {};
            const storage = new SerialStorage(
                internal,
                {
